                    ...
                    <?php get_sidebar('home'); ?>
                        <div class="portifolio col-md-8">
                            <div class="container">
                                ...
                                <div class="row">
                                <?php 
                                    $featured = new WP_Query( 'post_type=post&posts_per_page=1&cat=3,5' );
                                    if( $featured->have_posts() ):
                                    while( $featured->have_posts() ): $featured->the_post();
                                ?>
                                    <div class="col-12">
                                        <?php get_template_part('templates-parts/content', 'featured'); ?>
                                    </div>
                                    <?php
										endwhile;
										wp_reset_postdata();
                                ...
                                ?>
                                    <div class="col-sm-6">
                                        <?php get_template_part('templates-parts/content', 'secondary'); ?>
                                    </div>
                                    <?php
										endwhile;
										wp_reset_postdata();
